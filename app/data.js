...
export const apmFundamentalsPracticeExam = [
  {
    id: "apmf-1",
    question: "The Live Search view will display all ingested traces for how long?",
  ...
  {
    id: "apmf-4",
    question: "What is the PRIMARY challenge to monitoring the performance of typical distributed application environments?",
    options: [
  ...
  {
    id: "apmf-5",
    question: "Which of the following options BEST describes the percentile distribution metrics that are available for distribution metrics in APM?",
    options: [
  ...
  {
    id: "apmf-6",
    question: "The default APM pricing plan includes 1 million indexed spans per month, retained for how long?",
    options: ["7 days", "15 days", "30 days"],
    answer: "15 days",
  },
  {
    id: "apmf-7",
    question: "The Datadog Continuous Profiler can always be enabled with which method?",
    options: [
