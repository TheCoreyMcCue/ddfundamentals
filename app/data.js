...
export const logFundamentalsPracticeExam = [
  ...
  },
  {
    ...
    options: [
      "They provide high-granularity context for troubleshooting.",
      "They are the cheapest data type.",
      "They replace metrics.",
      "They are only for security.",
    ],
    answer: "They provide high-granularity context for troubleshooting.",
  },
  {
    id: "lf-4",
    question: "Which search query finds logs with error status that also contain the word 'info' in the message?",
    options: [
      'status:error "info"',
      "error AND info",
    ...
    answer: 'status:error "info"',
  },
  {
    id: "lf-5",
    question: "Which log format is automatically parsed by Datadog without any additional configuration?",
    options: ["JSON", "Syslog", "Common Log Format (CLF)", "XML"],
    answer: "JSON",
  },
  {
    id: "lf-6",
    question: "What is the key benefit of Logging Without Limits?",
    options: [
      "Decoupling ingestion from indexing",
      "Unlimited storage for free",
      "Auto-parsing of all logs",
      "No need for an Agent",
    ],
    answer: "Decoupling ingestion from indexing",
  },
  {
    id: "lf-7",
    question: "What is the default directory for logs on a Linux system?",
    options: ["/var/log", "/etc/log", "/usr/bin/logs", "/home/log"],
    answer: "/var/log",
  },
  {
    id: "lf-8",
    question: "Which Datadog product is used to detect security signals from logs?",
    options: ["Cloud SIEM", "Log Rehydration", "Sensitive Data Scanner", "APM"],
    answer: "Cloud SIEM",
  },
  {
    id: "lf-9",
    question: "What is the maximum number of facets supported in a Timeseries visualization?",
    options: ["1 (Timeseries)", "5", "10", "Unlimited"],
    answer: "1 (Timeseries)",
  },
  {
    id: "lf-10",
    question: "How do you create a dynamic URL that links to the appropriate dashboard in an alert message?",
    options: [
      "Use Template Variables",
      "Hardcode the link",
      "Use a Bitly integration",
      "Use a Grok parser",
    ],
    answer: "Use Template Variables",
  },
  {
    id: "lf-11",
    question: "Which directory must the dd-agent user own for the Datadog Agent to function correctly?",
    options: [
    ...
    answer: "/var/lib/datadog-agent",
  },
  {
    id: "lf-12",
    question: "How do you move a column in the Log Explorer List view?",
    options: [
    ...
    answer: "Drag and drop the column header",
  },
  {
    id: "lf-13",
    question: "Which view in Log Explorer allows you to visualize log counts broken down by a facet?",
    options: [
    ...
    answer: "Use the Analytics view",
  },
  {
    id: "lf-14",
    question: "Which Datadog feature would you use to aggregate logs into long-term KPIs and metrics?",
    options: [
    ...
    answer: "Generate Metrics from Logs",
  },
  {
    id: "lf-15",
    question: "What type of insight do logs primarily provide?",
    options: [
    ...
    answer: "What happened at a specific point in time",
  },
  {
    id: "lf-16",
    question: "Which feature would you use to exclude logs from processing based on a field value?",
    options: ["Exclusion Filters", "Grok Parsers", "Facets", "RBAC"],
    answer: "Exclusion Filters",
  },
  {
    id: "lf-17",
    question: "How do you hide sensitive material within log messages in Datadog?",
    options: [
    ...
    answer: "Sensitive Data Scanner",
  },
  {
    id: "lf-18",
    question: "Which log pipeline processor would you use to parse a non-standard JSON log?",
    options: [
      "Grok Parser",
  ...
  {
    id: "lf-19",
    question: "How do you add a sortable column in the Log Explorer List view?",
    options: [
      "Create a Facet from the attribute",
      "Pin the log",
      "Restart the Agent",
      "Add a tag in the CLI",
    ],
    answer: "Create a Facet from the attribute",
  },
  {
    id: "lf-20",
    question: "How would you notify stakeholders when a business metric derived from logs exceeds a threshold?",
    options: [
      "Create a Log Monitor",
      "Export to Excel",
      "Send a Live Tail link",
      "Tag them in the Grok parser",
    ],
    answer: "Create a Log Monitor",
  },
  {
    id: "lf-21",
    question: "Which Datadog feature should you use to collect logs from browser-based JavaScript applications?",
    options: [
      "Browser SDK",
      "Node.js Agent only",
      "Tail /var/log/js",
  ...
  {
    id: "lf-22",
    question: "Which command prints the loaded Datadog Agent configuration?",
    options: [
    ...
    answer: "datadog-agent config",
  },
  {
    id: "lf-23",
    question: "What is the primary benefit of using Standard Attributes in Datadog?",
    options: [
      "Cross-product correlation (e.g. Logs to APM)",
      "Lower cost",
      "Faster ingestion",
      "Automatic Grok parsing",
    ],
    answer: "Cross-product correlation (e.g. Logs to APM)",
  },
  {
    id: "lf-24",
    question: "What is the retention period for log-based metrics in Datadog?",
    options: ["15 months", "15 days", "30 days", "2 years"],
    answer: "15 months",
  },
  {
    id: "lf-25",
    question: "Where are browser logs stored by default when using the Datadog Browser SDK?",
    options: [
      "Browser Console",
      "/var/log/browser",
      "Datadog S3 bucket",
  ...
  {
    id: "lf-26",
    question: "Which log sources can the Datadog Agent tail natively?",
    options: [
      "Files, Sockets, and Journald",
      "Databases only",
      "Only Windows Event Viewer",
      "Only standard output",
    ],
    answer: "Files, Sockets, and Journald",
  },
  {
    id: "lf-27",
    question: "Which search query correctly finds logs for both the nginx and redis services?",
    options: [
      "service:(nginx OR redis)",
      "service:nginx + redis",
      "nginx AND redis",
      "app=nginx,redis",
    ],
    answer: "service:(nginx OR redis)",
  },
];
...
export const awsCloudPractitionerPracticeExam = [
  ...
  },
  {
    ...
    answer: ["AWS Identity and Access Management (AWS IAM)", "AWS Auto Scaling"],
    multiSelect: true,
  },
  {
    id: "acp-4",
